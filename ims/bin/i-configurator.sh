...
cd ../cfg
sudo ./configurator-ims.sh $domainname $ip_address

cd ../bind
sudo ./configurator-bind.sh $domainnameA $ip_addressA $domainnameB $ip_addressB  $ip_address

cd ../FHoSS/scripts
sudo ./configurator-FHoSS-scripts.sh $domainname $ip_address $visiteddomain

cd ../deploy
sudo ./configurator-FHoSS-deploy.sh $domainname $ip_address
